...
def main():
    ...
    output_file_path = os.path.join(proj_root, 'results', 'raw', 'no_anchor_quer_response_2_k20.json')
    ...
    simplified_output_path = os.path.join(proj_root, 'results', 'simplified', 'simplified_no_anchor_quer_response_2_k20.json')
    ...
    # save stats
    stats_output_path = os.path.join(proj_root, 'results', 'stats','stats_no_anchor_quer_response_2_k20.json')
